...
if __name__ == "__main__":
    ...
    parser.add_argument('--bert_model_path', type=str, help='The location of the bert model')
    ...
    parser.add_argument('--data_path', type=str, help='The location of the dataset')
